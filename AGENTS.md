...
- На время тестирования workflow Codex может самостоятельно мержить свой PR после успешных проверок, если пользователь явно не дал команду остановить или отменить auto-merge.
- Если пользователь отменит это правило, снова не мержить PR самостоятельно.
