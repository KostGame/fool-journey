...
SU-007 переводит основной режим `Путь Шута` в screen-by-screen flow. Теперь home не содержит длинную активную сцену, а сама игра идёт через отдельные экраны `scene` и `result`.
...
- Не добавлен backend или внешние API.

## 7. Риски и ограничения

- Это всё ещё только UX/refactor для текущего пути, а не расширение контента.
...
- PR URL: будет добавлен после открытия PR
- Ветка: `feature/su-007-single-screen-scene-flow`
