...
SU-006 переводит основной режим `Путь Шута` в формат dialogue-based text quest. В текущем vertical slice есть минимум 5 major scenes, 3 minor events и 3 court helper appearances. Для остальных сцен сохранён fallback, чтобы маршрут не ломался.
